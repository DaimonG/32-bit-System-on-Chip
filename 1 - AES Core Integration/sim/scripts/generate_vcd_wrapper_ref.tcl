...
run 20 ns
vcd add -file aes128keyWrapper_ref.vcd -r /aes128keywrappertb/uut/* 
# Run VCD time, depending on how long is the period you want to run your power analysis upon
run 660 ns
# Closes vcd file
vcd flush aes128keyWrapper_ref.vcd
vcd2saif -input aes128keyWrapper_ref.vcd -output aes128keyWrapper_ref.vcd.saif
