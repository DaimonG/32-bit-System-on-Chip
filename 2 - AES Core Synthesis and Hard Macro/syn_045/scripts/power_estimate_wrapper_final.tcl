...
read_verilog -netlist /ensc/cmc_homedirs/escmc29/ensc450/ENSC450finalproject/Part2/BE_045/results/verilog/aes128keyWrapper.final.v
...
set VCDFILES {/ensc/cmc_homedirs/escmc29/ensc450/ENSC450finalproject/Part1/sim/aes128keyWrapper_final.vcd.saif}

foreach file $VCDFILES {
    read_saif -input $file -instance aes128keywrappertb/uut -verbose
    report_power -analysis_effort high >> ./results/aes128keyWrapper_final.vcd.rpt
}
