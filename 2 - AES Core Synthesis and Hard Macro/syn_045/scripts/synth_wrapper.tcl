...
# Neeed to update this path 
analyze -format vhdl /ensc/cmc_homedirs/escmc29/ensc450/ENSC450finalproject/Part1/vhdl/aes128key.vhd
analyze -format vhdl /ensc/cmc_homedirs/escmc29/ensc450/ENSC450finalproject/Part1/vhdl/aes128keyWrapper.vhd
...
create_clock -name clock -period 5.7 -waveform {0 2.85} {clock}
...
set_input_delay  0.8 -max -clock clock  [all_inputs]
set_output_delay 0.8 -max -clock clock  [all_outputs]
