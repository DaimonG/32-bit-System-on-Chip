...
read_verilog -netlist /ensc/cmc_homedirs/escmc29/ensc450/ENSC450finalproject/Part2/syn_045/results/aes128keyWrapper.ref.v
...
set VCDFILES {/ensc/cmc_homedirs/escmc29/ensc450/ENSC450finalproject/Part1/sim/aes128keyWrapper.vcd.saif}

foreach file $VCDFILES {
    read_saif -input $file -instance aes128keywrappertb/uut
    report_power -analysis_effort high >> ./results/aes128keyWrapper_vcd_power.rpt
}
