...
read_verilog -netlist /ensc/cmc_homedirs/escmc29/ensc450/ENSC450finalproject/Part3/BE_045/results/verilog/ensc450.final.v
...
set VCDFILES {/ensc/cmc_homedirs/escmc29/ensc450/ENSC450finalproject/Part1/sim/ensc450_final.vcd.saif}

foreach file $VCDFILES {
    read_saif -input $file -instance e/UUT
    report_power -analysis_effort high >> ./results/ensc450_final_vcd_power.rpt
}
